...
void tester1() {
	TestCore console("Comprehensive test 1 ...", 1, 2 * MAXN);
	console.init();
...
void tester2() {
	TestCore console("Comprehensive test 2...", 2, 2 * MAXN);
	console.init();
	auto ret = generator(MAXN);
	try{
        Int::born = Int::dead = 0;
...
void tester3() {
	TestCore console("Comprehensive test 3...", 3, 2 * MAXN);
	console.init();
	auto ret = generator(MAXN);
	try{
        std::list<Int> stdlist;
...
void tester4() {
	TestCore console("Comprehensive test 4...", 4, 2 * MAXN);
	console.init();
